...
local normalBox,carryBox,laggerBox,laggerCarryBox,uiScaleBox,stealRadBox,stealDurBox,autoTPHeightBox  -- added autoTPHeightBox
...
local function Main()
    ...
    startAutoSteal()
    print("[Green Duels] Ready. Auto TP (downward) fixed, saves height correctly. Infinite Jump simplified. Keybinds save permanently. Added 3-second green countdown on ragdoll.")
end
